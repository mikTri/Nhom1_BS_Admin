...
const HomeSlidesList = () => {
    ...
    const breadcrumbs = [
        { href: '/dashboard', label: 'Dashboard', icon: <HomeIcon fontSize="small" /> },
        { href: '#', label: 'Home Banner Slide', icon: <ExpandMoreIcon /> }
    ];
    ...
    const deleteSlide = (id) => {
        ...
        deleteData(`/api/homeBanner/${id}`).then(res => {
            ...
            fetchDataFromApi('/api/homeBanner').then((res) => {
                setSlideList(res);
                context.setProgress(100);
                context.setProgress({ open: true, error: false, msg: "Slide Deleted!" })
            })
        })
    }
                ...
                <div className="card shadow border-0 w-100 flex-row p-4 align-items-center">
                    ...
                    {/* <div className="ml-auto d-flex align-items-center">
                        <Breadcrumbs aria-label="breadcrumb" className="ml-auto breadcrumbs_">
                            ...
                            <StyledBreadcrumb label="Home Banner Slide"
