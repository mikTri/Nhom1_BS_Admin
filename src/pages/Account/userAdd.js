...
const UserAdd = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!file || !formFields.name || !formFields.email || !formFields.phone || !formFields.address) {
        ...
        try {
            ...
            // Sign up the user
            const res = await postData('/api/user/signup', updatedFormFields);
    
            if (!res.error) {
                setIsLoading(true);
                context.setAlertBox({ open: true, msg: 'Người dùng đã được tạo!', error: false });
            ...
            context.setAlertBox({ open: true, error: true, msg: 'Đã xảy ra lỗi khi đăng ký người dùng' });
    ...
    return (
        <div className="right-content w-100">
            <div className="card shadow border-0 w-100 p-3">
                <h5 className="mb-0">Thêm khách hàng mới</h5>
